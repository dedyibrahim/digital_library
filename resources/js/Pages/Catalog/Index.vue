                ...
                <section class="mt-9">
                    ...
                    <div v-else class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        <article v-for="book in books.data" :key="book.id" class="overflow-hidden rounded-xl border border-slate-200 bg-slate-50 hover:shadow-md">
                            ...
                            <button v-if="(book.object_key || book.file_path) && $page.props.auth.user" @click="openPreview(book)" class="mx-3 h-40 overflow-hidden rounded-lg bg-white text-center shadow-sm hover:ring-2 hover:ring-blue-400"><FileThumbnail :book="book" /></button><div v-else class="mx-3 h-40 overflow-hidden rounded-lg bg-white text-center shadow-sm"><FileThumbnail :book="book" /></div>
